...
CONTENT = [
  {"title": 'Fast prototyping', 'icon': 'far fa-lightbulb',
   'content': 'Innovate and prototype easily by only using one page. Epyk will make the link to the underlying technologies for you.'},
  {"title": 'Ease & Efficient', 'icon': 'fas fa-user-friends',
   'content': 'Anyone can use and produce amazing and highly configurable web pages. At the end you only import the packages you really need.'},
...
VIGNETS = [
  {"image": "https://raw.githubusercontent.com/epykure/epyk-studio/master/static/shops.PNG", 'title': 'FROM E-COMMERCE',
   "content": '''The library will provide a rich range of components ready to use to design your web pages. 
...
QUOTE = '''
Using Epyk is quite easy to use and it allows to write JavaScript, HTML and CSS without any knowledge in those domains.
It is really a toolbox to help Python developers to learn the web, share their ideas and get them exposed quickly to clients.
'''

BANNER_ABOUT = {
  'title': "About Epyk",
  'content': '''
Epyk target is to allow light and advanced Python developers to give a new dimension to their scripts.
